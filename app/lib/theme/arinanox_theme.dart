...
/// arinanoX Design System
///
/// Dark-first, terminal-inspired aesthetic.
/// ATM from DroidDesk's DroidTheme — simplified for arinanoX brand.
class ArinanoxTheme {
  ArinanoxTheme._();
  ...
  // ── Accent Colors (arinanoX brand: teal + amber) ──
  ...
  // ── Distro color ──
  static const Color debianColor = Color(0xFFD70A53);
